...
# ==============================================          /     State wise       /             ============================================== #
    ...
    with tab4:
        ...
        df_st_us_tab_qry_rslt = pd.DataFrame(np.array(st_us_tab_qry_rslt), columns=['Quarter', 'User_ Count'])
        ...
        df_st_us_tab_qry_rslt1['User _Count'] = df_st_us_tab_qry_rslt1['User_ Count'].astype(int)
        df_st_us_tab_qry_rslt1_fig = px.bar(df_st_us_tab_qry_rslt1 , x = 'Quarter', y ='User_ Count', color ='User_ Count', color_continuous_scale = 'thermal', title = 'User Analysis Chart', height = 500,)
